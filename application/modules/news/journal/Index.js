    ...
    render: function () {
        ...
        return (
            <div className="news_container">
                <div ref="news" className="news_content_list">
                    <Advert position="4" />
                    <NewsList key={this.state.pointer} pointer={this.state.pointer} onSelect={this.selectPointer} onSelectArticle={this.selectArticle} />


                </div>
                <div className="news_content_info">
                    <NewsInfo articleId={this.state.articleId} key={this.state.articleId} />
                    <NewsHotList key={this.state.pointer + 1} pointer={this.state.pointer}  onSelectArticle={this.selectArticle} />
                </div>
            </div>
        );
    }
