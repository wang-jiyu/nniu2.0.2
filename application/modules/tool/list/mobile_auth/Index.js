        ...
        UserCenterHandle.authId(params, function(result) {
            if (result.code == 200)
                return this.setState({
                            ...
                            Interface.jsCallNative('realNameSuccess');
                        });
            return this.setState({
                    ...
                    <div className="content">
                        <dl>
                            ...
                            <dd>
                                ...
                                <div>本人同意并不撤销授权北京首证投资顾问有限公司及其提供身份验证的第三方服务公司对本人的身份信息进行核验并留存相关身份信息。</div>
                                <div>本人在此声明充分理解上述授权含义，知晓并自愿承担由此带来的可能发生的任何影响。</div>
                                <div> 本授权一旦确认立即生效。</div>
                            </dd>
                        </dl>
                    </div>
