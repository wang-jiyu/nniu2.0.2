...
module.exports = React.createClass({
    ...
    getRoomComplete: function (result) {
        if (result.code == 200) {
            ...
            return this.setState({
                ...
                menu: arr,
                isFollow: Config.CACHE_DATA.USER.follow_ids?Config.CACHE_DATA.USER.follow_ids.indexOf(Config.CACHE_DATA.ROOM.advisor._id) != -1:false
            }, this.route);
        }
    ...
    getRoomInfo: function () {
        var roomId = '4c96e9783ada87e434f5ee42';
        ...
        return <div className="live_box">
            ...
            <div className="main">
                <div className="curr-sidebar">
                    <div className="curr-go-index"><p>返回首页</p></div>
                    <div className="curr-refresh">刷新</div>
                    {(this.state.room.live_type == 1) ? (
                        <div className="curr-refresh" onClick={this.setMenu}>节目单</div>) : ""}
                </div>
            </div>
            <LiveHead info={this.state.room}/>
